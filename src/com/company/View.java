        ...
        while (true) {
            ...
            switch (answer) {
                ...
                case "4": {
                    ...
                    String inventoryType = scanner.nextLine();
                    controller.findInventoryByType(inventoryType, Integer.parseInt(storageNumber), new Date(System.currentTimeMillis()));
                    break;
                }
                case "5": {
                    System.out.println("Введите имя инвентаря");
                    String inventoryName = scanner.nextLine();
                    controller.findingAdditionAndConsumption(inventoryName);
                    break;
                }
                case "6": {
                    Date currentDate = new Date(System.currentTimeMillis());
                    controller.findingStorageByDate(currentDate);
                    break;
                }
            }
        }
